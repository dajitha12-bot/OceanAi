...
HAS_GDAL = False
try:
    from django.contrib.gis.gdal import HAS_GDAL as gdal_present
    HAS_GDAL = gdal_present
    if not HAS_GDAL:
...
if DATABASE_URL:
    ...
    # Override backend if GDAL is not present to prevent import crashes
...
DATABASES = {
    'default': db_config or {
        'ENGINE': 'django.contrib.gis.db.backends.postgis' if HAS_GDAL else 'django.db.backends.postgresql',
